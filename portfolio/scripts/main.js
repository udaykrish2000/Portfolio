...
(() => {
  ...
  const commands = [
    ...
    { label: "Open GitHub Profile", href: "https://github.com/udaykrishna-dev", external: true },
    { label: "Open LinkedIn Profile", href: "https://linkedin.com/in/udaykrishna-dev", external: true },
  ];
  let cmdkActive = 0;
  ...
  --------------------------------------------------------------------- */
  const GITHUB_USERNAME = "udaykrishna-dev"; // change to your real GitHub username
